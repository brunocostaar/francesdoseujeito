...
export const professora = {
  ...
  /**
   * Versão curta da bio: cinco parágrafos em vez de nove. O que ficou é
   * o que vende — tempo de estrada, títulos, habilitação DELF/DALF,
   * instituições e o convite final.
   */
  bio: [
  ...
  credenciais: [
    "Doutora em Letras — Cultura e Tradução (UFPB)",
